...
def load_metadata(metadata, participant, return_filenames: bool = False):
    ...
    with open(metadata, "r") as f:
        ...
        for i, line in enumerate(f.readlines()[1:]):
            ...
            key = fname + f"_{participant}"
            metadict_byfname[key] = has_finger, speaker_id
            if key not in seen:
                seen.add(key)
    ...
    if return_filenames:
        return num_speakers, metadict_byfname, metadict_byindex, filenames
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataroot', type=str, default='/home/yqr/DATASETS/Genea2023/genea2023_dataset/')
